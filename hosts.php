            ...
            <div class="card-body">
              ...
              <form method="post" enctype="multipart/form-data">
                  ...
                  <div class="mb-3">
                      ...
                      <input type="text" class="form-control" name="name" value="<?= $editMember['name'] ?? '' ?>" required>
                  </div>
                  <div class="mb-3">
                      <label class="form-label">Role / Show:</label>
                      <input type="text" class="form-control" name="role" value="<?= $editMember['role'] ?? '' ?>" required>
                  </div>
                  <div class="mb-3">
                      ...
                      <?php if ($editMode && $editMember['image_path']): ?>
                          <p class="mt-2">Current: <img src="TEAM/<?= $editMember['image_path'] ?>" height="60"></p>
                      <?php endif; ?>
                  </div>
